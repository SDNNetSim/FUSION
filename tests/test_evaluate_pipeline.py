...
class TestEvaluationPipeline:
    ...
    def test_compare_algorithms(self, _mock_log, mock_runner_class):
        ...
        mock_runner.run.side_effect = [
            [{'erlang': 300.0, 'stats': {'blocking_probability': 0.01, 'total_requests': 1000}}],
            [{'erlang': 300.0, 'stats': {'blocking_probability': 0.02, 'total_requests': 1000}}]
        ]
        mock_runner_class.return_value = mock_runner
    ...
    def test_generate_markdown_summary(self, _mock_log, _mock_create_directory, mock_file):
        ...
        mock_file.assert_called_once_with(output_path / 'summary.md', 'w', encoding='utf-8')
        handle = mock_file()
