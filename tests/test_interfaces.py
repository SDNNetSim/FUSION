...
class TestInterfaceCompliance(unittest.TestCase):
    ...
    def test_interface_methods_are_abstract(self):
        ...
        abstract_methods = {
            method for method in dir(AbstractRoutingAlgorithm)
        ...
        expected_methods = {
            'algorithm_name', 'supported_topologies', 'validate_environment',
            'route', 'get_paths', 'update_weights', 'get_metrics'
        }
    ...
    def test_interface_has_required_methods(self):
        ...
        expected_routing = ['algorithm_name', 'supported_topologies', 'validate_environment',
                            'route', 'get_paths', 'update_weights', 'get_metrics', 'reset']

        for method in expected_routing:
            self.assertTrue(hasattr(AbstractRoutingAlgorithm, method))

        # Test spectrum interface methods
        expected_spectrum = ['algorithm_name', 'supports_multiband', 'assign',
                             'check_spectrum_availability', 'allocate_spectrum',
                             'deallocate_spectrum', 'get_fragmentation_metric',
                             'get_metrics', 'reset']
        ...
        expected_agent = ['algorithm_name', 'action_space_type', 'observation_space_shape',
                          'act', 'train', 'learn_from_experience', 'save', 'load',
                          'get_reward', 'update_exploration_params', 'get_config',
                          'set_config', 'get_metrics', 'reset', 'on_episode_start',
                          'on_episode_end']
