...
class TestPlotHelpers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plot_helpers = PlotHelpers(
            plot_props=self.plot_props, net_names_list=self.net_names_list
        )
        ...
        self.example_sim_dict = {
            "iter_stats": {
                "0": {
                    "mods_used_dict": {"100": {"QPSK": 2, "16QAM": 3}},
                    "snapshots_dict": {
                        "1": {
                            "active_requests": 10,
                            "blocking_prob": 0.05,
                    ...
                    "block_reasons_dict": {"congestion": [0.1], "distance": [1000]},
                }
            },
            "blocking_mean": 0.02,
    ...
    def test_update_plot_dict(self):
        ...
        self.assertIsInstance(
            self.plot_helpers.plot_props.plot_dict[self.plot_helpers.time][
                self.plot_helpers.sim_num
            ],
            PlotArgs,
        )
    ...
    def test_find_mod_info(self):
        ...
        modulations_dict = self.plot_helpers.plot_props.plot_dict[
            self.plot_helpers.time
    ...
    def test_find_misc_stats(self):
        ...
        plot_args = self.plot_helpers.plot_props.plot_dict[self.plot_helpers.time][
            self.plot_helpers.sim_num
        ]
    ...
    def test_find_times(
        self, mock_open_func, mock_check_filters, mock_isdir, mock_listdir
        ...
        mock_listdir.side_effect = [
            ...
            [
                "network_sim_1.json",
                "network_sim_2.json",
            ],  # Second call for simulation files in time1
            [
                "network_sim_1.json",
                "network_sim_2.json",
            ],  # Third call for simulation files in time2
        ]
