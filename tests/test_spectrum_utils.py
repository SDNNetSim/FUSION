...
class TestSpectrumHelpers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.engine_props = {"allocation_method": "first_fit", "guard_slots": 1}
        ...
        self.helpers = SpectrumHelpers(
            self.engine_props, self.sdn_props, self.spectrum_props
        )

    def test_check_free_spectrum(self):
        """Test the _check_free_spectrum method."""
        # Set necessary variables
        self.helpers.current_band = "c"
        self.helpers.core_number = 0
    ...
    def test_update_spec_props(self):
        ...
        self.assertEqual(self.spectrum_props.core_number, 0)
        self.assertEqual(self.spectrum_props.current_band, "c")
    ...
    def test_check_super_channels(self):
        ...
        self.assertTrue(
            self.helpers.check_super_channels(open_slots_matrix, flag="forced_index")
        )
    ...
    def test_check_free_spectrum_l_band_only(self):
        ...
        self.helpers.current_band = "l"  # Test with 'l' band
        self.helpers.core_number = 0
        self.helpers.start_index = 0
        self.helpers.end_index = 5
    ...
    def test_check_super_channels_s_band_only(self):
        ...
        self.sdn_props.network_spectrum_dict[(1, 2)]["cores_matrix"]["c"][0][:] = 1
        self.sdn_props.network_spectrum_dict[(1, 2)]["cores_matrix"]["l"][0][:] = 1

        self.helpers.current_band = "s"
        self.helpers.core_number = 0
        self.spectrum_props.slots_needed = 2
        self.helpers.engine_props["guard_slots"] = 1
    ...
    def test_check_other_links_l_band_only(self):
        ...
        # Fill the 'c' band and make the 'l' band available
        self.sdn_props.network_spectrum_dict[(1, 2)]["cores_matrix"]["c"][0][:] = 1
        self.sdn_props.network_spectrum_dict[(2, 3)]["cores_matrix"]["c"][0][:] = 1

        self.helpers.current_band = "l"
        self.helpers.core_number = 0
        self.helpers.start_index = 0
        self.helpers.end_index = 5
