...
class TestCreateDirectory:
    ...
    def test_create_directory_with_valid_path_creates_directory(
    ...
    @patch("fusion.utils.os.Path")
    def test_create_directory_with_nested_path_creates_parents(
        self, mock_path_class: Mock
    ) -> None:
    ...
    @patch("fusion.utils.os.Path")
    def test_create_directory_with_existing_directory_succeeds(
        self, mock_path_class: Mock
    ) -> None:
    ...
    @patch("fusion.utils.os.Path")
    def test_create_directory_resolves_relative_path(
        self, mock_path_class: Mock
    ) -> None:
...
class TestFindProjectRoot:
    ...
    @patch("fusion.utils.os.Path")
    def test_find_project_root_with_git_directory_returns_root(
        self, mock_path_class: Mock
    ) -> None:
        ...
        mock_current.__truediv__ = Mock(
            side_effect=lambda x: mock_git_dir if x == ".git" else mock_run_sim
        )
    ...
    @patch("fusion.utils.os.Path")
    def test_find_project_root_with_run_sim_file_returns_root(
        self, mock_path_class: Mock
    ) -> None:
    ...
    @patch("fusion.utils.os.Path")
    def test_find_project_root_searches_upward_until_found(
        self, mock_path_class: Mock
    ) -> None:
        ...
        mock_child.__truediv__ = Mock(
            side_effect=lambda x: child_git if x == ".git" else child_run_sim
        )
        ...
        mock_parent.__truediv__ = Mock(
            side_effect=lambda x: parent_git if x == ".git" else parent_run_sim
        )
    ...
    @patch("fusion.utils.os.Path")
    def test_find_project_root_at_filesystem_root_raises_error(
        self, mock_path_class: Mock
    ) -> None:
    ...
    def test_find_project_root_without_start_path_uses_current_file(
        self, mock_path_class: Mock
    ) -> None:
    ...
    @patch("fusion.utils.os.Path")
    def test_find_project_root_with_both_markers_returns_root(
        self, mock_path_class: Mock
    ) -> None:
