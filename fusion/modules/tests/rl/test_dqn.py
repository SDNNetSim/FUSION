...
"""Unit tests for fusion.modules.rl.algorithms.dqn module."""
...
class TestDQN:
    ...
    # --------------------------- helpers ------------------------------
    @staticmethod
    def _mk_engine(k_paths: int | None = 3) -> SimpleNamespace:
        """Return minimal stub for engine_obj."""
        return SimpleNamespace(engine_props={"k_paths": k_paths})

    @staticmethod
    def _mk_agent(k_paths: int | None = 3) -> dqn.DQN:
    ...
    # ---------------------- get_obs_space -----------------------------
    @mock.patch("fusion.modules.rl.algorithms.dqn.spaces.Dict")
    @mock.patch(
    ...
    # ------------------- get_action_space -----------------------------
    @mock.patch("fusion.modules.rl.algorithms.dqn.spaces.Discrete")
