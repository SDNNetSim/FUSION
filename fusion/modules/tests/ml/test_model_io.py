...
class TestExportModelForDeployment:
    ...
    def test_export_pickle_format_creates_pickle_file(
        ...
        # Act
        result = export_model_for_deployment(
            model, export_path, 'pickle'
        )
...
class TestCheckModelCompatibility:
    ...
    @patch('fusion.modules.ml.model_io.joblib.load')
    def test_check_compatibility_with_matching_features(
        self,
        mock_load: Mock
    ) -> None:
    ...
    @patch('fusion.modules.ml.model_io.joblib.load')
    def test_check_compatibility_with_feature_names(
        self,
        mock_load: Mock
    ) -> None:
    ...
    @patch('fusion.modules.ml.model_io.joblib.load')
    def test_check_compatibility_handles_load_error(
        self,
        mock_load: Mock
    ) -> None:
