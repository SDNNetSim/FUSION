...
@pytest.fixture
def first_fit_spectrum(engine_props: dict[str, Any], sdn_props: SDNProps, route_props: MagicMock) -> FirstFitSpectrum:
...
class TestFirstFitSpectrumProperties:
    ...
    def test_algorithm_name_returns_first_fit(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_supports_multiband_returns_true(self, first_fit_spectrum: FirstFitSpectrum) -> None:
...
class TestAssignMethod:
    ...
    def test_assign_with_valid_path_returns_assignment(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_assign_with_bandwidth_calculates_slots(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_assign_with_empty_path_raises_error(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_assign_with_none_request_raises_error(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_assign_with_no_available_slots_returns_none(self, first_fit_spectrum: FirstFitSpectrum, sdn_props: SDNProps) -> None:
...
class TestCalculateSlotsNeeded:
    ...
    def test_calculate_slots_needed_with_integer_bandwidth(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_calculate_slots_needed_with_fractional_bandwidth_rounds_up(self, first_fit_spectrum: FirstFitSpectrum) -> None:
...
class TestCheckSpectrumAvailability:
    ...
    def test_check_spectrum_availability_with_free_slots_returns_true(self, first_fit_spectrum: FirstFitSpectrum) -> None:
        ...
        # Act
        result = first_fit_spectrum.check_spectrum_availability(path, start_slot, end_slot, core_num, band)

        # Assert
        assert result is True

    def test_check_spectrum_availability_with_occupied_slots_returns_false(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_check_spectrum_availability_with_missing_link_returns_false(self, first_fit_spectrum: FirstFitSpectrum) -> None:
...
class TestAllocateSpectrum:
    ...
    def test_allocate_spectrum_with_valid_params_returns_true(self, first_fit_spectrum: FirstFitSpectrum, sdn_props: SDNProps) -> None:
        ...
        # Act
        result = first_fit_spectrum.allocate_spectrum(path, start_slot, end_slot, core_num, band, request_id)
    ...
    def test_allocate_spectrum_with_missing_link_returns_false(self, first_fit_spectrum: FirstFitSpectrum) -> None:
...
class TestDeallocateSpectrum:
    ...
    def test_deallocate_spectrum_with_allocated_slots_frees_them(self, first_fit_spectrum: FirstFitSpectrum, sdn_props: SDNProps) -> None:
        ...
        # First allocate
        first_fit_spectrum.allocate_spectrum(path, start_slot, end_slot, core_num, band, request_id)

        # Act - Deallocate
        result = first_fit_spectrum.deallocate_spectrum(path, start_slot, end_slot, core_num, band)
    ...
    def test_deallocate_spectrum_with_missing_link_returns_false(self, first_fit_spectrum: FirstFitSpectrum) -> None:
...
class TestGetFragmentationMetric:
    ...
    def test_get_fragmentation_metric_with_minimal_fragmentation(self, first_fit_spectrum: FirstFitSpectrum, sdn_props: SDNProps) -> None:
...
class TestGetMetrics:
    ...
    def test_get_metrics_with_no_assignments_returns_zero_average(self, first_fit_spectrum: FirstFitSpectrum) -> None:
    ...
    def test_get_metrics_after_assignments_returns_correct_values(self, first_fit_spectrum: FirstFitSpectrum) -> None:
...
class TestReset:
    ...
    def test_reset_clears_assignment_counts(self, first_fit_spectrum: FirstFitSpectrum) -> None:
