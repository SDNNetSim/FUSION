...
@pytest.fixture
def last_fit_spectrum(engine_props: dict[str, Any], sdn_props: SDNProps, route_props: MagicMock) -> LastFitSpectrum:
...
class TestLastFitSpectrumProperties:
    ...
    def test_algorithm_name_returns_last_fit(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_supports_multiband_returns_true(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestAssignMethod:
    ...
    def test_assign_with_valid_path_returns_assignment(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_assign_with_bandwidth_calculates_slots(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_assign_with_no_available_slots_returns_none(self, last_fit_spectrum: LastFitSpectrum, sdn_props: SDNProps) -> None:
...
class TestCalculateSlotsNeeded:
    ...
    def test_calculate_slots_needed_with_integer_bandwidth(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_calculate_slots_needed_with_fractional_bandwidth_rounds_up(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestFindLastContiguousBlock:
    ...
    def test_find_last_contiguous_block_with_available_slots_returns_dict(
        ...
        # Act
        result = last_fit_spectrum._find_last_contiguous_block(core_array, core_num, band)
    ...
    def test_find_last_contiguous_block_with_no_space_returns_none(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_find_last_contiguous_block_with_insufficient_slots_returns_none(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestCheckSpectrumAvailability:
    ...
    def test_check_spectrum_availability_with_free_slots_returns_true(self, last_fit_spectrum: LastFitSpectrum) -> None:
        ...
        # Act
        result = last_fit_spectrum.check_spectrum_availability(path, start_slot, end_slot, core_num, band)

        # Assert
        assert result is True

    def test_check_spectrum_availability_with_occupied_slots_returns_false(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_check_spectrum_availability_with_missing_link_returns_false(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestAllocateSpectrum:
    ...
    def test_allocate_spectrum_with_valid_params_returns_true(self, last_fit_spectrum: LastFitSpectrum, sdn_props: SDNProps) -> None:
        ...
        # Act
        result = last_fit_spectrum.allocate_spectrum(path, start_slot, end_slot, core_num, band, request_id)
    ...
    def test_allocate_spectrum_with_missing_link_returns_false(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestDeallocateSpectrum:
    ...
    def test_deallocate_spectrum_with_allocated_slots_frees_them(self, last_fit_spectrum: LastFitSpectrum, sdn_props: SDNProps) -> None:
        ...
        # First allocate
        last_fit_spectrum.allocate_spectrum(path, start_slot, end_slot, core_num, band, request_id)

        # Act
        result = last_fit_spectrum.deallocate_spectrum(path, start_slot, end_slot, core_num, band)
    ...
    def test_deallocate_spectrum_with_missing_link_returns_false(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestGetFragmentationMetric:
    ...
    def test_get_fragmentation_metric_with_minimal_fragmentation(self, last_fit_spectrum: LastFitSpectrum, sdn_props: SDNProps) -> None:
...
class TestGetMetrics:
    ...
    def test_get_metrics_with_no_assignments_returns_zero_average(self, last_fit_spectrum: LastFitSpectrum) -> None:
    ...
    def test_get_metrics_after_assignments_returns_correct_values(self, last_fit_spectrum: LastFitSpectrum) -> None:
...
class TestReset:
    ...
    def test_reset_clears_assignment_counts(self, last_fit_spectrum: LastFitSpectrum) -> None:
