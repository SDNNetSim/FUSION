...
# Evaluation exports
from fusion.modules.ml.evaluation import (analyze_prediction_errors,
                                          compare_models, cross_validate_model,
                                          evaluate_classifier,
...
from fusion.modules.ml.feature_engineering import (  # Previously get_ml_obs
    create_interaction_features, create_polynomial_features,
    engineer_network_features, extract_ml_features)
# Model I/O exports
from fusion.modules.ml.model_io import (check_model_compatibility,
                                        export_model_for_deployment,
                                        load_model, load_model_with_metadata,
                                        save_model, save_model_ensemble)
# Preprocessing exports
from fusion.modules.ml.preprocessing import (  # Previously even_process_data; Previously process_data
    balance_training_data, normalize_features, prepare_prediction_features,
    process_training_data, split_features_labels)
# Registry (unchanged)
# from fusion.modules.ml.registry import *  # Empty file, no exports needed
# Visualization exports
from fusion.modules.ml.visualization import (  # Previously plot_confusion; Previously plot_data
    plot_2d_clusters, plot_3d_clusters, plot_confusion_matrix,
    plot_data_distributions, plot_feature_importance)
