...
class TestComputeActionMask:
    ...
    def test_mask_failed_paths(self):
    ...
    def test_mask_insufficient_spectrum(self):
    ...
    def test_mask_both_conditions(self):
    ...
    def test_all_paths_feasible(self):
    ...
    def test_all_paths_infeasible(self):
    ...
    def test_boundary_case_exact_slots(self):
    ...
    def test_boundary_case_one_less_slot(self):
...
class TestApplyFallbackPolicy:
    ...
    def test_fallback_returns_negative_on_failure(self):
    ...
    def test_fallback_uses_relaxed_mask(self):
