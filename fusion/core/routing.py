...
class Routing:
    ...
    def find_least_weight(self, weight: str) -> None:
        ...
        """
        logger.warning(
            "find_least_weight is deprecated. Use get_route() with appropriate route_method."
        )
    ...
    def find_k_shortest(self) -> None:
        ...
        """
        logger.warning(
            "find_k_shortest is deprecated. Use get_route() with route_method='k_shortest_path'."
        )
    ...
    def find_least_nli(self) -> None:
        ...
        """
        logger.warning(
            "find_least_nli is deprecated. Use get_route() with route_method='nli_aware'."
        )
    ...
    def find_least_cong(self) -> None:
        ...
        """
        logger.warning(
            "find_least_cong is deprecated. Use get_route() with route_method='least_congested'."
        )
    ...
    def find_least_frag(self) -> None:
        ...
        """
        logger.warning(
            "find_least_frag is deprecated. Use get_route() with route_method='frag_aware'."
        )
    ...
    def find_cong_aware(self) -> None:
        ...
        """
        logger.warning(
            "find_cong_aware is deprecated. Use get_route() with route_method='cong_aware'."
        )
    ...
    def load_k_shortest(self) -> None:
        ...
        """
        logger.warning(
            "load_k_shortest is deprecated. Use get_route() with route_method='external_ksp'."
        )
