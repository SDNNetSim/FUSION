...
class AgentInterface(ABC):
    ...
    @abstractmethod
    def act(self, observation: Any, deterministic: bool = False) -> Union[int, Any]:
    ...
    @abstractmethod
    def learn_from_experience(self, observation: Any, action: Union[int, Any],
                              reward: float, next_observation: Any,
    ...
    @abstractmethod
    def get_reward(self, state: Dict[str, Any], action: Union[int, Any],
