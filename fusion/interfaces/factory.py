...
class AlgorithmFactory:
    ...
    def create_routing_algorithm(
        ...
        :param name: Name of the routing algorithm
        :type name: str
    ...
    def create_spectrum_algorithm(
        ...
        :param name: Name of the spectrum algorithm
        :type name: str
        :param engine_props: Engine configuration properties
        :type engine_props: dict
        :param sdn_props: SDN controller properties
        ...
        :rtype: AbstractSpectrumAssigner
        :raises ValueError: If algorithm name is not found
        """
        try:
    ...
    def create_snr_algorithm(
        ...
        :param name: Name of the SNR algorithm
        :type name: str
        :param engine_props: Engine configuration properties
        :type engine_props: dict
        :param sdn_props: SDN controller properties
...
class SimulationPipeline:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        :param config: Configuration dictionary containing algorithm selections
                and parameters
    ...
    def _create_routing_algorithm(self) -> AbstractRoutingAlgorithm:
        ...
        return AlgorithmFactory.create_routing_algorithm(
            routing_name,
            self.engine_props,
            self.sdn_props,  # type: ignore[arg-type]
        )
    ...
    def _create_spectrum_algorithm(self) -> AbstractSpectrumAssigner:
        ...
        return AlgorithmFactory.create_spectrum_algorithm(
            ...
            self.engine_props,
            self.sdn_props,
            self.route_props,  # type: ignore[arg-type]
        )
    ...
    def _process_snr_and_allocation(
        self,
        result: dict[str, Any],
        path: Any,
        spectrum_assignment: dict[str, Any],
        request: Any,
    ) -> None:
    ...
    def reset_all_algorithms(self) -> None:
