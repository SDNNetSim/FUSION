...
class TestV1DataAdapter:
    ...
    def test_can_handle_v1_format(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
        """Should recognize V1 format."""
        assert v1_adapter.can_handle(sample_v1_data)

    def test_can_handle_v2_format_returns_false(
        self, v1_adapter: V1DataAdapter, sample_v2_data: dict[str, Any]
    ) -> None:
        """Should not recognize V2 format."""
        assert not v1_adapter.can_handle(sample_v2_data)

    def test_can_handle_missing_fields_returns_false(
        self, v1_adapter: V1DataAdapter
    ) -> None:
        """Should return False for data without V1 fields."""
        data = {"unknown_field": 123}
        assert not v1_adapter.can_handle(data)

    def test_to_canonical_converts_v1_data(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_to_canonical_preserves_iteration_data(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_to_canonical_extracts_metadata(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_to_canonical_wrong_format_raises_error(
        self, v1_adapter: V1DataAdapter, sample_v2_data: dict[str, Any]
    ) -> None:
...
class TestV2DataAdapter:
    ...
    def test_can_handle_v2_format(
        self, v2_adapter: V2DataAdapter, sample_v2_data: dict[str, Any]
    ) -> None:
        """Should recognize V2 format."""
        assert v2_adapter.can_handle(sample_v2_data)

    def test_can_handle_v1_format_returns_false(
        self, v2_adapter: V2DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_to_canonical_converts_v2_data(
        self, v2_adapter: V2DataAdapter, sample_v2_data: dict[str, Any]
    ) -> None:
    ...
    def test_to_canonical_extracts_timing_info(
        self, v2_adapter: V2DataAdapter, sample_v2_data: dict[str, Any]
    ) -> None:
...
class TestDataAdapterRegistry:
    ...
    def test_default_adapters_registered(
        self, adapter_registry: DataAdapterRegistry
    ) -> None:
    ...
    def test_get_adapter_for_v1_data(
        self, adapter_registry: DataAdapterRegistry, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_get_adapter_for_v2_data(
        self, adapter_registry: DataAdapterRegistry, sample_v2_data: dict[str, Any]
    ) -> None:
    ...
    def test_get_adapter_unsupported_format_raises_error(
        self, adapter_registry: DataAdapterRegistry
    ) -> None:
    ...
    def test_get_adapter_by_version(
        self, adapter_registry: DataAdapterRegistry
    ) -> None:
    ...
    def test_get_adapter_by_nonexistent_version(
        self, adapter_registry: DataAdapterRegistry
    ) -> None:
...
class TestCanonicalData:
    ...
    def test_get_final_blocking_probability_from_field(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_get_final_blocking_probability_from_iterations(
        self, v1_adapter: V1DataAdapter
    ) -> None:
    ...
    def test_get_last_k_iterations(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_get_metric_simple_path(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
    ...
    def test_get_metric_nested_path(
        self, v1_adapter: V1DataAdapter, sample_v1_data: dict[str, Any]
    ) -> None:
