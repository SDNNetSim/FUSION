...
class TestJsonSimulationRepository:
    ...
    @pytest.fixture
    def repository(self, tmp_path: Path, metadata_repository: FileMetadataRepository) -> JsonSimulationRepository:
    ...
    @pytest.fixture
    def setup_test_data(self, tmp_path: Path, sample_v1_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def test_find_runs_success(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_find_runs_with_algorithm_filter(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_find_runs_with_run_ids_filter(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_find_runs_nonexistent_date(self, repository: JsonSimulationRepository, tmp_path: Path) -> None:
    ...
    def test_get_run_data_success(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any], sample_v1_data: Dict[str, Any]) -> None:
    ...
    def test_get_run_data_uses_cache(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_run_data_not_found(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_run_data_invalid_json(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_run_data_batch_success(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_run_data_batch_partial(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_exists_run_directory(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_exists_specific_traffic_volume(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_available_traffic_volumes(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_metadata(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_clear_cache(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
    ...
    def test_get_cache_stats(self, repository: JsonSimulationRepository, setup_test_data: Dict[str, Any]) -> None:
