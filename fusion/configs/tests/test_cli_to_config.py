...
class TestCLIToConfigMapper:
    ...
    def test_get_cli_override_config_new_sections(self) -> None:
        ...
        base_config = {
            'general_settings': {'holding_time': 5}
        }
        cli_args = {
    ...
    def test_get_cli_override_config_nested_dict_copy(self) -> None:
        ...
        base_config = {
            'general_settings': {'nested': {'key': 'value'}}
        }
        cli_args = {'holding_time': 10}
    ...
    def test_mapping_consistency(self) -> None:
        ...
        valid_sections = {
            'general_settings', 'topology_settings', 'spectrum_settings',
            'snr_settings', 'rl_settings', 'ml_settings', 'file_settings'
        }
