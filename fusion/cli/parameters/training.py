...
def add_reinforcement_learning_args(parser: argparse.ArgumentParser) -> None:
    ...
    rl_group.add_argument(
        "--path_model",
        type=str,
        help="Path to pre-trained path selection model"
    )
    rl_group.add_argument(
        "--core_model",
        type=str,
        help="Path to pre-trained core selection model"
    )
    rl_group.add_argument(
        "--spectrum_model",
        type=str,
    ...
    rl_group.add_argument(
        ...
        type=float,
        default=1.0,
        help="Reward value for successful actions"
    )
    rl_group.add_argument(
        "--penalty",
        type=float,
...
def add_machine_learning_args(parser: argparse.ArgumentParser) -> None:
    ...
    ml_group.add_argument(
        "--deploy_model",
        action="store_true",
        help="Deploy trained model for inference"
    )
