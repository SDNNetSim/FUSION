...
from .simulation import add_run_sim_args, register_run_sim_args, add_simulation_args
from .routing import add_routing_args, add_spectrum_args, add_modulation_args, add_sdn_args
from .network import add_network_args, add_topology_args, add_link_args, add_node_args, add_spectrum_bands_args
...
from .training import add_all_training_args, add_reinforcement_learning_args, add_machine_learning_args
from .analysis import add_all_analysis_args, add_statistics_args, add_plotting_args, add_export_args, \
    add_comparison_args, add_filtering_args
