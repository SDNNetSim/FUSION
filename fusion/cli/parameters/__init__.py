...
from .network import (add_all_network_args, add_link_args, add_network_args,
                      add_node_args, add_spectrum_bands_args,
                      add_topology_args)
from .registry import ArgumentRegistry, args_registry
from .routing import (add_all_routing_args, add_modulation_args,
                      add_routing_args, add_sdn_args, add_spectrum_args)
...
from .training import (add_all_training_args, add_feature_extraction_args,
                       add_machine_learning_args, add_optimization_args,
