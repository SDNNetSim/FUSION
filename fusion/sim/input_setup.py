...
def create_input(base_fp: str, engine_props: dict) -> dict:
    ...
    :return: Engine props modified with network, physical topology, and bandwidth
        information
    :rtype: dict
    :raises RuntimeError: If bandwidth info file is empty or invalid after multiple
        attempts
    """
