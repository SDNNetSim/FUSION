...
class EvaluationPipeline:
    ...
    def evaluate_model(self, model_path: str, test_configs: list[dict]) -> dict:
        ...
        results = {"model_path": model_path, "test_results": []}
    ...
    def _generate_comparison_report(self, results: dict[str, dict]) -> dict:
        ...
        report = {"algorithms": list(results.keys()), "metrics": {}, "rankings": {}}
    ...
    def _generate_markdown_summary(self, results: dict, output_path: Path):
        ...
        with open(md_path, "w", encoding="utf-8") as f:
            ...
            if "model" in results:
                ...
                f.write(
                    f"- Test configurations: {len(results['model']['test_results'])}\n\n"
                )
            ...
            if "rl" in results:
                ...
                f.write(
                    f"- Mean blocking: {rl['mean_blocking']:.4f} ± {rl['std_blocking']:.4f}\n"
                )
